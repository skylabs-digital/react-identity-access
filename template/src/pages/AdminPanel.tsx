      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: '0.875rem', color: '#1e40af' }}>
            This page is protected by <code>ProtectedRoute</code> with <code>minUserType={UserType.TENANT_ADMIN}</code>.
            Only TENANT_ADMIN and SUPERUSER can access this content.
          </p>
        </div>
      </div>
    </div>
